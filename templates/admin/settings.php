...
<div id="tab-container" class="tab-container">
	...
	<p><button class="button button-primary" onclick=updateOptions('<?php echo json_encode($sendUpdate)?>')><?php _e('Setting settings', $this->plugin_meta['shortname'])?></button></p>
</div>
