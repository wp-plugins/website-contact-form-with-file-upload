...
echo '<div class="grid grid-pad">';
		...
		$photoedit = (isset($single_form -> photo_editing)) ? $single_form -> photo_editing : '' ;
		/*
		...
		*/
		...
		echo '<input type="hidden" name="_photo_editing" value="'.$photoedit.'">';
		...
		case 'text':
			$thevalue = (isset($value)) ? $value : '';
			$requi = (isset($meta['required'])) ? $meta['required'] : '';

			echo '<div id="box-'.$name.'" class="col-'.$meta['width'].'-12">';
			echo '<label for="'.$name.'">'. $field_label.' </label> <br />';
			echo '<input type="text" name="'.$name.'" id="'.$name.'"';
			echo 'value="'.$thevalue.'" data-type="'.$type.'"';
			echo 'data-req="'.$requi.'"';
		...
		case 'email':
			$thevalue = (isset($value)) ? $value : '';
			$requi = (isset($meta['required'])) ? $meta['required'] : '';
			$sendemail = (isset($meta['send_email'])) ? $meta['send_email'] : '';
		...
		case 'select':
			...
			echo 'data-req="'.$requi.'"';
			echo 'data-message="'.stripslashes( $meta['error_message'] ).'">';
				echo '<option value="">'.__('Select option', 'nm_webcontact').'</option>';
